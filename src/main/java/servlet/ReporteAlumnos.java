 ...
 * @author SASHA
 */
@WebServlet(name = "ReporteAlumnos", urlPatterns = {"/reportealumnos"})
public class ReporteAlumnos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxmlPath = getServletContext().getRealPath("/ReporteAlumnos.jrxml");
            ...
            response.setHeader("Content-Disposition", "inline; filename=reporteAlumnos.pdf");
